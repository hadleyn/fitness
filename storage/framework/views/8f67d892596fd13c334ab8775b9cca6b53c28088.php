<?php /* /var/www/html/fitness-dev/resources/views/dashboard/fatreductionplanform.blade.php */ ?>
...
<div class="container">
  ...
  <?php endif; ?>
  <form method="POST" action="/dashboard/saveReduceFatPlan">
    <?php echo csrf_field(); ?>
    <?php if(isset($plan)): ?>
    ...
    <div class="form-group">
      <label for="startingFatPercentage">Starting Body Fat Percentage</label>
      <?php if(empty($plan->id)): ?>
        <input type="text" class="form-control" id="startingFatPercentage" name="startingFatPercentage" value="<?php echo e(old('startingFatPercentage')); ?>">
      <?php else: ?>
        <input type="text" class="form-control" id="startingFatPercentage" name="startingFatPercentage" value="<?php echo e(old('startingFatPercentage', $plan->plannable->starting_fat_percentage)); ?>">
      <?php endif; ?>
    </div>
    <div class="form-group">
      ...
      <?php else: ?>
        <input type="text" class="form-control" id="planGoal" name="planGoal" value="<?php echo e(old('planGoal', $plan->plannable->goal_fat_percentage)); ?>">
      <?php endif; ?>
    </div>
    <div class="form-group">
