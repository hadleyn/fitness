<?php /* /var/www/html/fitness-dev/resources/views/dashboard/calorieplanform.blade.php */ ?>
...
<div class="container">
  ...
  <?php endif; ?>
  <form method="POST" action="/dashboard/saveCaloriePlan">
    <?php echo csrf_field(); ?>
    <?php if(isset($plan)): ?>
    ...
    <div class="form-group">
    	<p>Calorie Plans work best when linked to a weight plan. Click here to link to an existing weight plan or create a new one</p>	
    </div>
    <div class="form-group">
      <label for="startingWeight">Starting Weight</label>
      <?php if(empty($plan->id)): ?>
        <input type="text" class="form-control" id="startingWeight" name="startingWeight" value="<?php echo e(old('startingWeight')); ?>">
      <?php else: ?>
        <input type="text" class="form-control" id="startingWeight" name="startingWeight" value="<?php echo e(old('startingWeight', $plan->plannable->starting_weight)); ?>">
      <?php endif; ?>
    </div>
    <div class="form-group">
      ...
      <?php else: ?>
        <input type="text" class="form-control" id="planGoal" name="planGoal" value="<?php echo e(old('planGoal', $plan->plannable->goal_weight)); ?>">
      <?php endif; ?>
    </div>
    <div class="form-group">
