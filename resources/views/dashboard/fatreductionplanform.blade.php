...
<div class="container">
  ...
  <form method="POST" action="/dashboard/saveReduceFatPlan">
    ...
    <div class="form-group">
      ...
      @if (empty($plan->id))
        <input type="text" class="form-control" id="startingFatPercentage" name="startingFatPercentage" value="{{ old('startingFatPercentage') }}">
      @else
        <input type="text" class="form-control" id="startingFatPercentage" name="startingFatPercentage" value="{{ old('startingFatPercentage', $plan->plannable->starting_fat_percentage) }}">
      @endif
    </div>
    <div class="form-group">
      ...
      @else
        <input type="text" class="form-control" id="planGoal" name="planGoal" value="{{ old('planGoal', $plan->plannable->goal_fat_percentage) }}">
      @endif
    </div>
    <div class="form-group">
